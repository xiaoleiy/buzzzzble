(function() {
	...
	/*
	 * 	Buzzzzble.DAO
	 * 		findMePublicActivites
	 * 		findMeSelfActivities
	...
	var DAO = {
		...
		findCommentsByActivityId : function(activityId, funcs){
			var apiobj = {
				buzzapi_type : 'GET',
				buzzapi_alt : 'json',
				buzzapi_uri : BUZZ_API.ACTIVITIES.ME.SELF + '/' + activityId + '/@comments'
			};
			DAO.request(apiobj, funcs);
		},
		...
		makeItBuzzzzble : function(content, funcs) {
			var apiobj = {
				...
				buzzapi_uri : BUZZ_API.ACTIVITIES.ME.SELF,
				buzzapi_alt : 'json',
				buzzapi_postData : '{"data": {"object": {"type": "note", "content": "' + content + '"}}}'
			};
			DAO.request(apiobj, funcs);
		}
	}
